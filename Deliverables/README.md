...
| **João**    | 6.2, 7 e 8     | - [X] Complete **DFDs** (Level 0, Level 1 and Level 2 if necessary). <br> - [X] **Risk Assessment** table and methodology (Justified prioritisation). <br> - [X] Catalogue of **Mitigations** (`MIT-xx`) linked to high risks. <br>                                            |  [X]   |
